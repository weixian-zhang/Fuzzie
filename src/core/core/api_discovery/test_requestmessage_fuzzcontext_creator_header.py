...
class TestRequestMessageFuzzContextCreator_By_Header(unittest.TestCase):
    ...
    def test_reqmsg_parser_headers_with_singleline_qs(self):
        ...
        self.assertTrue(apicontext.fuzzcaseSets[0].headerNonTemplate != '{"Content-Type": " application/xml", "Authorization": " token xxx"}')
